...
function draw(){
 ...
 strokeWeight(5);
  ...
  scale(5);
  lights();
 triangle(-locationData.latitude,-locationData.latitude,-locationData.latitude,locationData.longitude,5,locationData.altitude);
pop();
  push();
 scale(5);
textSize(5);
 text( "la "+locationData.latitude+" ", -locationData.latitude + 20,-locationData.latitude);
   text( "la "+locationData.latitude+" ", -locationData.latitude + 20,-locationData.latitude);
     text( "  lo  "+locationData.longitude+" ", -locationData.latitude + 20,locationData.longitude);
     text( "  alt  "+locationData.altitude+" ", 5 + 20,locationData.altitude);
  pop();
}
